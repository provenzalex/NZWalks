    ...
    public class NZWalksDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var difficulties = new List<Difficulty>
            {
                new Difficulty
                {
                    Id = Guid.Parse("200f9377-399b-4952-9c50-4edd22ee6e9a"),
                    Name = "Easy"
                },
                new Difficulty
                {
                    Id =  Guid.Parse("cc007ba9-6c66-4b25-8c75-1981ef1009db"),
                    Name = "Medium"
                },
                new Difficulty
                {
                    Id =  Guid.Parse("745fa594-2e3d-4f31-a4d4-f943d3a7d870"),
                    Name = "Hard"
                }
            };

            // Seed the difficulties to the database
